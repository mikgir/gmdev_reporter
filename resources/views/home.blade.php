                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        ...
                                        <div class="type-post larg-post color-{{ $news->category_id }}">
                                            <div class="entry-cover"><a href="#"><img src="{{ $news->image }}"
                                                                                      ...
                                                                                      alt="Post"/></a></div>
                                            <div class="entry-content">
                                                <div class="post-category"><a href="#" title="{{ $news->category->title }}">{{ $news->category->title }}</a>
                                                </div>
                        ...
                        @foreach($newsList as $news )
                            <div class="col-xs-12">
                                ...
                                <div class="type-post color-{{ $news->category_id }}">
                                    ...
                                    <div class="entry-content">
                                        <div class="post-category"><a href="#" title="{{ $news->category->title }}">{{ $news->category->title }}</a></div>
                                        <h3 class="entry-title"><a href="#">{{ $news->title }}</a></h3>
                                        <p>{!! $news->description !!}</p>
                                        <div class="entry-footer">
                                            <span class="post-date"><a href="#">{{ date('Y-m-d') }}</a></span>
